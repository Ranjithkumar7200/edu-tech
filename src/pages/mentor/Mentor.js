...
const Mentor = () => {
  ...
  const members = [
    ...
    },
    {
      name: "Rohith",
      avatar: rohith,
      role: "Angular,Spring Boot - devupvers",
    },
    {
      name: "Lavanya",
      avatar: lavanya,
    ...
    <div >
      <div className="background ">
        <div className="right-container ">
          ...
          <span ><p style={{ textAlign: "center", margin: "10px" }}>Accelerate Your Skills with Industry Experts on Real-Time Projects</p></span>
        </div>
