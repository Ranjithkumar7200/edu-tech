...
export const TCSData = [
    {
        ...
        paragraph: `<strong >TR<br> </strong > Intro<br> Family details<br> Explain projects in a way that you are explaining to your parents without using technical words<br> Is there any specific reason to select Python as your comfortable programming language?<br> Resume-based questions<br> Certification related questions<br> Data structures - trees and graphs<br> HTML and CSS related (mentioned in my resume)<br> Write code for pre-order, post-order, and inorder traversal<br> Generative AI vs AI<br> ML vs DL<br> Write a code for 4×4 matrix multiplication<br> Write a code for merge sort<br> Some Networking questions<br>
...
`
    ...
    {
        heading: "TCS",
        paragraph: `Not even one HR question they asked me, even they didn’t ask me to introduce myself and directly asked me to explain my projects.<br>
I have been roasted by them; I know the entire project code which I developed for my banking application, but they asked me to explain regarding Eclipse IDE (process of creating a project & options available in the toolbar 🥲).<br>
What is an arch file?<br>
They asked me 2-3 file types which I don’t know, and I hadn’t even heard of before, like an "ace" file... something like that (I don’t remember exactly).<br>
...
It’s very nice. The interviewers are very friendly and very nice.<br>
...
Have any experience in leadership? (I’ve mentioned leadership in soft skills)<br>
...
It’s really good experience, but I thought it would be more effective if the interview process is done peer-to-peer.<br>
...
`
    ...
    {
        paragraph: `The interview experience was wonderful. The interviewer was very calm, supportive, and friendly, which made me feel comfortable. Even when I struggled at times, she patiently listened and didn’t hesitate to help. The questions were a mix of basic and intermediate levels, which gave me a good chance to show what I know. Overall, it was a positive and encouraging experience that boosted my confidence. The questions were based on OOP, DSA, and basic/intermediate level problem-solving. We were asked to solve the problem statement they gave. The compiler was available in the superset itself.<br>`
    },
